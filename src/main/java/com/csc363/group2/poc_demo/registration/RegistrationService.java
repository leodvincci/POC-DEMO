...
//import com.csc363.group2.poc_demo.email.EmailSender;
import com.csc363.group2.poc_demo.registration.token.ConfirmationToken;
import com.csc363.group2.poc_demo.registration.token.ConfirmationTokenService;
    ...
    public String register(RegistrationRequest request) {
        ...
        String token = appUserService.signUpUser(
                new AppUser(
                        ...
                        request.getEmail(),
                        request.getPassword(),
                        request.getAppUserRole() == null?AppUserRole.USER:request.getAppUserRole()
